...
def roc_pr_curve(y_true, y_scores, path_experiment):
    ...
    np.save('/root/dilation_supervised/1/DRIVE/fpr.npy', fpr)
    np.save('/root/dilation_supervised/1/DRIVE/tpr.npy', tpr)
    AUC_ROC = auc(fpr, tpr)
    ...
    np.save('/root/dilation_supervised/1/DRIVE/precision.npy', precision)
    np.save('/root/dilation_supervised/1/DRIVE/recall.npy', recall)
